...
trait Effect {
  ...
  // TODO: this can't inherently be inferred - some card effects copy another effect
  val activator: Player = Card.controller
  ...
  protected[this] def cause = EffectCause(this, activator)
